        ...
        >
          ...
          <header className="flex flex-col items-center px-6 pt-12 pb-6">
            ...
            <div className="group relative mb-6">
              ...
              <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-700 dark:bg-[var(--surface-dark)]">
                <svg
          ...
          <div className="space-y-5 px-6 pb-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white p-3 transition-colors hover:bg-slate-50 disabled:opacity-50 dark:border-slate-700 dark:bg-[var(--surface-dark)] dark:hover:bg-slate-700"
              >
                <svg
                  className="h-5 w-5"
                  viewBox="0 0 24 24"
