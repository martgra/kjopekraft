...
const navItems: NavItem[] = [
  ...
  { href: '/history', label: 'History', icon: 'history', disabled: true },
...
export default function Sidebar() {
  ...
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-[var(--border-light)] bg-[var(--surface-light)]">
